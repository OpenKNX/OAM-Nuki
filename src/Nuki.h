...
#define FCB_VisibleChannels                     7375      // uint8_t
...
// Parameter per channel
#define FCB_ParamBlockOffset 7376
...
#define BASE_KommentarModuleParamOffset 8441
